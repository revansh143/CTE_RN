...
function CTEPriceQuoteWebView({navigation,route}){
    React.useEffect(() => {
      ...
      const dashboardURL = route.params["priceURL"]
      console.log(route.params["priceURL"])
...
export default CTEPriceQuoteWebView